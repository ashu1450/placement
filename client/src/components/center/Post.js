...
import MyVerticallyCenteredModal from "../Pages/Answers/Answers";
//import MyVerticallyCenteredModal from "./answer";
        ...
        <div className="post">
          ...
          <div className="post__body">
            <div className="post__question">
              ...
              <button className="post__btnAnswer" onClick={() => setModalShow(true)}>Answer</button>
